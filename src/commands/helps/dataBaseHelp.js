	...
	message.channel.send({
		...
		embed: {
			...
			fields: [
				...
				{
					name: `${bot.config.prefix}showTable *<nom de la table>*`,
					value: "```Pour afficher tous les élément de la table précisée en argument.```"
				},
				{
					name: `${bot.config.prefix}dropTable *<nom de la table>*`,
